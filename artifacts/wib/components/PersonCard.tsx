    ...
    <GlassCard style={styles.card}>
      <View style={styles.row}>
        ...
        <View style={styles.info}>
          ...
          {person.organization ? (
            <Text style={[styles.org, { color: colors.muted }]}>{person.organization}</Text>
          ) : null}
          {person.email ? (
            <Text style={[styles.contact, { color: colors.onSurfaceVariant }]}>{person.email}</Text>
          ) : null}
        </View>
